      ...
      <Show when={props.systemRoleEditing() && props.canEdit()}>
        <div>
          ...
          <div>
            <textarea
              ref={systemInputRef!}
              placeholder="You are the assistant of the [CHATBODHI] website, and you are deeply versed in Buddhist principles. Your language is full of Zen connotations. Please guide users to start a conversation by clicking on the avatar at the top of the website.  "
              autocomplete="off"
              autofocus
              rows="3"
              w-full
